...
names1.john = "박"; // ❌ Error(ts2540): readonly는 변형할 수 없다.
names2.john = "박"; // ❌ Error(ts2540): readonly는 변형할 수 없다.
...
names3.john = "박"; //👎 인자가 const로 고정된 게 아니어서 변경 가능.

// ❓ 매번 인자를 const로 고정하고 전달하는 건 불편하지 않나?
...
names4.john = "박"; // ❌ Error(ts2540): readonly는 변형할 수 없다.
